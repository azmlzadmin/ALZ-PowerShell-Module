function New-Platform-Landing-Zone {
    ...
    if ($skip_requirements_check.IsPresent) {
        ...
        Write-ToConsoleLog "Checking the software requirements for the Accelerator..." -IsSuccess
        #Test-Tooling -skipAlzModuleVersionCheck:$skip_alz_module_version_requirements_check.IsPresent
    }

    Write-ToConsoleLog "Getting ready to deploy the accelerator with you..." -IsSuccess -NewLine
    ...
    if ($PSCmdlet.ShouldProcess("Accelerator setup", "modify")) {
        ...
        if ($inputConfigFilePaths.Length -eq 0) {
            ...
            if ($null -ne $envInputConfigPaths -and $envInputConfigPaths -ne "") {
                ...
                Write-ToConsoleLog "No input configuration file path has been provided. Please specify using -inputConfigFilePaths parameter or ALZ_input_config_path environment variable." -IsError
                throw "No input configuration file path has been provided. Please specify using -inputConfigFilePaths parameter or ALZ_input_config_path environment variable."
            }
        }
        ...
        if ($inputConfig.iac_type.Value -eq "") {
            Write-ToConsoleLog "No Infrastructure as Code type has been specified. Please specify using -iac_type parameter or in your configuration file." -IsError
            throw "No Infrastructure as Code type has been specified. Please specify using -iac_type parameter or in your configuration file."
        }

        if ($inputConfig.iac_type.Value -eq "bicep") {
            Write-ToConsoleLog "Although you have selected Bicep, the Accelerator leverages the Terraform tool to bootstrap your Version Control System and Azure. This is will not impact your choice of Bicep post this initial bootstrap. Please refer to our documentation for further details..." -IsWarning
        }
        ...
        Write-ToConsoleLog "Checking and Downloading the bootstrap module..." -IsSuccess -NewLine
        $versionAndPath = New-ModuleSetup `
            ...
            -release $bootstrap_module_version `
        ...
        if ($inputConfig.bootstrap_module_name.Value -eq "") {
            Write-ToConsoleLog "No bootstrap module name has been specified. Please specify using -bootstrap_module_name parameter or in your configuration file." -IsError
            throw "No bootstrap module name has been specified. Please specify using -bootstrap_module_name parameter or in your configuration file."
        }
        ...
        if ($hasStarterModule) {
            Write-ToConsoleLog "Checking and downloading the starter module..." -IsSuccess -NewLine
